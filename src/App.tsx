...
function App() {
  ...
  return (
    <div className='bg-gradient-to-r from-[#E8F7EC] to-[#F0F9FF] h-full'>
      {/* feladat címe */}
      <div className='pt-4 pl-16 font-semibold text-[30px]'>{taskData.task_title}</div>
      {/* feladat leírása */}
      <div className='pt-4 pl-16 font-semibold text-[20px]'>{taskData.task_description}</div>
      
      <div className='flex flex-wrap'>
        {/* bal rész: slotok */}
        <div className='grid grid-cols-2 relative w-3/5 gap-y-4 gap-x-8 pt-6 pl-16 pr-12'>
