          ...
          <div className='ml-[140px] flex items-center'>
            <Link to={'/StudentView'}>
              <div className='px-3 py-3'>
                <div className='h-[36px] px-2 border-[2px] border-secondary rounded-[8px] flex items-center justify-center text-secondaryFont hover:text-gray font-bold drop-shadow-lg'>Előnézet</div>
              </div>
            </Link>
            <div className='px-3'>
              <div className='h-[36px] px-2 border-[2px] border-primary bg-primary text-white rounded-[8px] flex items-center justify-center text-secondaryFont hover:text-[#f2f2f2] font-bold drop-shadow-lg'
                onClick={() => setIsModalOpen(true)}>Feladatsor mentése</div>
            </div>
          </div>
      </div>

      <div className="flex gap-8 font-semibold text-[20px] text-primary">
        <div className={`h-full flex items-center ${location.pathname.includes('worksheets') ? ' border-b-[3px] border-primary' : 'hover:border-b-[3px] border-primary'}`}>
          <button
        ...
        <div className={`h-full flex items-center ${location.pathname.includes('Class') || location.pathname.includes('teacherHomePage') ? ' border-b-[3px] border-primary' : 'hover:border-b-[3px] border-primary'}`}>
          <button
