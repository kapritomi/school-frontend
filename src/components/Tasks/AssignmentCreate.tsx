...
export default function AssignmentCreate({ task, index }: { task: TaskJson; index: number }) {
            ...
            <div className="flex justify-between ">
              ...
              {coords.length > 0 ? (
                <button
                  type="button"
                  onClick={clearAll}
                  className="h-12 flex gap-2 text-end w-[240px] text-delete font-semibold cursor-pointer p-2"
                >
