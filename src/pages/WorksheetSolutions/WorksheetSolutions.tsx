  ...
  return (
    <div className="w-screen h-screen flex flex-col overflow-hidden">
      ...
      <div className="mt-[70px] flex-1 overflow-auto px-[41px] pb-16">
        ...
        {worksheetSolutions && worksheetSolutions.solutions.length === 0 ? (
          <p className="text-[20px] font-semibold mt-16">
            Nincs kitöltése a feladatlapnak
          </p>
        ) : (
          worksheetSolutions && (
            <div className="relative w-fit border border-lightBorder  rounded-lg">
              ...
              >
                ...
                {worksheetSolutions.tasks.map((task) => (
                  <div
                    key={task.task_id}
                    className="text-white bg-primary text-center text-[20px] p-3 "
                  >
                    {task.task_title}
                  </div>
                ))}
                ...
                {worksheetSolutions.solutions.map((student) => (
                  ...
                  >
                    ...
                    {student.details.map((detail) => (
                      <div
                        key={detail.task_id}
                        className="text-center p-4 border-r font-medium  text-[25px] border-lightBorder"
                      >
                        {detail.score}P
                      </div>
                    ))}
